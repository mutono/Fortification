...
class Front extends CI_Controller {
	...
	<table border="0" width="98%">
		...
		<tr class="clonable">
			<td width="144">
			<input type="text"  name="iodineDate1" id="iodineDate1"/>
			</td>
			<td width="144">
			<input type="text"  name="iodineSupplier1" />
			</td>
			<td width="144">
			<input type="text"  name="iodineDrums" id="iodineDrums"/>
			</td>
			<td width="144">
			<input type="text"  name="IiodineLot" id="iodineLot"/>
			</td>
			<td width="144">
			<input type="text"  name="iodineExpiration" id="iodineExpiration"/>
			</td>
			<td width="144">
			<input type="text" name="iodineDispatched" id="iodineDispatched"/>
			</td>
			<td width="144">
			<input type="text" name="iodineStock" id="iodineStock"/>
			</td>
			<td width="141">
			<input type="text" name="iodineReceipt" id="iodineReceipt"/>
			</td>
		</tr>
	...
	public function internalFort_B1() {
		...
		$internalFortified_B1 .= '<form name="internalFortified_B1" id="internalFortified_B1" method="post" action="' . base_url() .'data/submit/form_internalFort_B1' . '"><!--Form for internal monitoring of salt fortification- B1-->
						...
						<tr class="clonable">
						   <td width="12.5%"><input type="text" name="fortifiedDate" id="fortifiedDate"/></td>
						   <td width="12.5%"><input type="text" name="fortifiedWeight" id="fortifiedWeight"/></td>
						   <td width="12.5%"><input type="text" name="compoundWeight" id="compoundWeight"/></td>
						   <td width="12.5%"><input type="text" name="finalWeight" id="finalWeight"/></td>
						   <td width="12.5%"><input type="text" name="startTime" id="startTime" class="mobiscroll" readonly="readonly" value="" /></td>
						   <td width="12.5%"><input type="text" name="endTime" id="endTime" class="mobiscroll" readonly="readonly" value="" /></td>
						   <td width="12.5%"><input type="text" name="iodineWeight" id="iodineWeight"/></td>
						   <td width="12.5%"><input type="text" name="qcReview" id="qcReview"/></td>
						</tr>
						<tr id="formbuttons" class="clonable">
	...
	public function internalFort_C1() {
		...
		$internalFortified_C1 .= '<form name="internalFortified_C1" id="internalFortified_C1" method="post" action="' . base_url() .'data/submit/form_internalFort_C1' . '"><!--form for internal fortification of salts-C1-->
                         ...
                         <tr class="clonable">
                             <td width="15%"><input type="text" name="productionTime" id="productionTime" class="mobiscroll" readonly="readonly" value="" /></td>
                             <td width="15%"><input type="text" name="saltProduced" id="saltProduced"/></td>
                             <td width="15%"><input type="text" name="premixUsed" id="premixUsed"/></td>
                             <td width="15%"><input type="text" name="saltFortified" id="saltFortified"/></td>
                             <td width="18%"><input type="text" name="notes" id="notes"/></td>
                             <td width="18%"><input type="text" name="comments" id="comments"/></td>
...
<tr class="clonable">
     <td width="25%"><input type="text" name="auditorName" id="auditorName"/></td>
     <td width="20%"><input type="text" name="auditorPosition" id="auditorPosition"/></td>
     <td width="25%"><input type="text" name="auditorSignature" id="auditorSignature"/></td>
     <td width="15%"><input type="text" name="auditorOpening" id="auditorOpening"/></td>
     <td width="15%"><input type="text" name="auditorClosing" id="auditorClosing"/></td>
</tr>
<tr id="formbuttons" class="clonable">
...
';
	...
	public function smallScale_A1() {
		...
		$smallScale_A1 .= '<form name="smallScale_A1" id="smallScale_A1" method="post" action="">
					...
					<tr class="clonable">
						 <td width="144"><input type="text" name="controlDate" id="controlDate"/></td>
						 <td width="144"><input type="text" name="supplierName" id="supplierName"/></td>
						 <td width="144"><input type="text" name="controlKg" id="controlKg"/></td>
						 <td width="144"><input type="text" name="controlLot" id="controlLot"/></td>
						 <td width="144"><input type="text" name="iodineContent" id="iodineContent"/></td>
						 <td width="144"><input type="text" name="amountUsed" id="amountUsed"/></td>
						 <td width="144"><input type="text" name="inStock" id="inStock"/></td>
						 <td width="140"><input type="text" name="premixAmount" id="premixAmount"/></td>
					</tr>
					<tr id="formbuttons" class="clonable">
	...
	public function smallScale_A2() {
		$smallScale_A2 = '';
		$smallScale_A2 .= '
 <form name="" method="post" action=""><!--form for internal monitoring of salt fortification- A2-->
                        ...
                        <tr>
                           ...
                           <tr class="clonable">
                           <td width="12.5%"><input type="text" class="" name="sDate" id="pDate"/></td>
                           <td width="12.5%"><input type="text" class="" name="supplierNames" id="supplierNames"/></td>
                           <td width="12.5%"><input type="text" class="" name="kgs" id="kgs"/></td>
                           <td width="12.5%"><input type="text" class="" name="lotNumbers" id="lotNumbers"/></td>
                           <td width="12.5%"><input type="text" class="" name="contentOfiodine" id="contentOfiodine"/></td>
                           <td width="12.5%"><input type="text" class="" name="amountsUsed" id="amountsUsed"/></td>
                           <td width="12.5%"><input type="text" class="" name="inStocks" id="inStocks"/></td>
                           <td width="12.5%"><input type="text" class="" name="saltProduced" id="saltProduced"/></td>
                         </tr>
                         <tr id="formbuttons" class="clonable">
